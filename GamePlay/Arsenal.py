    ...
    def OnPlayerKilled( self, victim, killer, weapon ):
        ...
        if not killer or victim == killer:
            ...
            if vL > 0:
                ...
                GEUtil.PlaySoundToPlayer( victim, "GEGamePlay.Token_Drop_Enemy" )
                GEUtil.EmitGameplayEvent( "ar_levelchange", "%i" % victim.GetUserID(), "%i" % ( vL + 1 ), "suicide" )
            ...
            if name == "weapon_knife" and vL > 0:
                ...
                GEUtil.PlaySoundToPlayer( victim, "GEGamePlay.Token_Drop_Enemy" )
                GEUtil.EmitGameplayEvent( "ar_levelchange", "%i" % victim.GetUserID(), "%i" % ( vL + 1 ), "knifed" )
                ...
                if vL > 0:
                    ...
                    GEUtil.PlaySoundToPlayer( victim, "GEGamePlay.Token_Drop_Enemy" )
                    GEUtil.EmitGameplayEvent( "ar_levelchange", "%i" % victim.GetUserID(), "%i" % ( vL + 1 ), "slapped" )
                else:
            ...
            GEUtil.EmitGameplayEvent( "ar_levelchange", "%i" % killer.GetUserID(), "%i" % ( self.GetLevel( killer ) + 1 ) )
            ...
            if self.GetLevel( killer ) < maxLevel:
                ...
                GEUtil.PlaySoundToPlayer( killer, "GEGamePlay.Token_Grab_Enemy" )
