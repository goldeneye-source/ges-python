...
#/////////////////////////// Utility Functions ///////////////////////////
    ...
    def PlayTeamSounds( self, team ):
        if team == GEGlobal.TEAM_MI6:
            GEUtil.PlaySoundToTeam( GEGlobal.TEAM_MI6, "GEGamePlay.Token_Grab" )
            GEUtil.PlaySoundToTeam( GEGlobal.TEAM_JANUS, "GEGamePlay.Token_Drop_Friend" )
        elif team == GEGlobal.TEAM_JANUS:
            GEUtil.PlaySoundToTeam( GEGlobal.TEAM_MI6, "GEGamePlay.Token_Drop_Friend" )
            GEUtil.PlaySoundToTeam( GEGlobal.TEAM_JANUS, "GEGamePlay.Token_Grab" )
